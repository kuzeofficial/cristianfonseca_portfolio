        ...
        <Layout >
            <main>
                ...
                <Section title='Portfolio' id='portfolio'>
                    ...
                    <Card author="Cristian Fonseca" title="RickandMorty - GraphQL" description="A SPA to search for characters from the Rick and Morty series using the rickandmortyapi.com API, created using for entrainment of GraphQL" date="February 2, 2020" codelink="https://github.com/kuzeofficial/rickmortyapi" livecode="https://rickmortyapigql.vercel.app/"/>
