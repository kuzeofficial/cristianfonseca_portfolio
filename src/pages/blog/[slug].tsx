...
export default function Post({ source, frontmatter }: PostProps) {
  return (
    <>
      ...
      <Layout>
        <h1 className="textblock text-center font-bold tracking-wide text-transparent theme-gradient bg-clip-text items-center text-4xl lg:text-5xl md:text-3xl sm:text-3xl mb-4">
          {frontmatter.title}
        </h1>
        <div className="flex justify-between mb-2">
          <div className="flex flex-row items-center">
            <Image
              ...
              height="40px"
              width="40px"
              className="rounded-full lg:w-9 w-9 "
              alt={frontmatter.author}
            />
            <h3 className="flex-wrap ml-2">{frontmatter.author}</h3>
          </div>
          <div className="flex flex-row items-center">
            <h3 className="flex-wrap content-center justify-end text-red-400 font-bold">
              {frontmatter.date}{" "}
            </h3>
