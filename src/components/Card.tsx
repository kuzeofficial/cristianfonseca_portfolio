      ...
      <div className="border-primary border hover:shadow-md rounded w-auto md:w-1/1 sm:w-1/1 lg:w-1/1 h-auto mx-7 flex flex-col justify-center p-3">
        <div className="w-100 items-center flex justify-between mb-1">
          ...
          <div>
            {codelink && (
              <a
                className="no-underline hover:underline text-sm sm:static font-semibold text-red-400 mr-2"
                target="_blank"
                href={codelink}
                rel="noreferrer"
              >
            ...
            <a
              className="no-underline hover:underline text-sm sm:static font-semibold text-blue-400"
              target="_blank"
              href={livecode}
              rel="noreferrer"
            >
